<main class="home-page">
    <h1>Home</h1> 
    <p>
        Hallo, mijn naam is Tim Terwijn. Leuk dat je mijn website bezoekt. Deze website gebruik ik om mijn <a href="/curriculum-vitae" title="Open de CV pagina van Tim Terwijn">CV</a> en <a href="/portfolio" title="Open de portfolio pagina van Tim Terwijn">Portfolio</a> te delen met geintresseerde.<br>
        <br>
        Momenteel studeer ik Software engineering aan de HvA en zit ik in het 5e jaar. De programmeertalen waar ik het meest plezier aan beleef zijn PHP en Java.<br>
        <br>
